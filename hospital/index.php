...
<div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Bhumi Hospital Management System</h5></div>
                </div>
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/slider_3.jpg" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Bhumi Hospital Management System</h5>
 </div>
                </div>
            </div>
    ...
    <section id="services" class="key-features department">
        <div class="container">
            <div class="inner-title">
                ...
                <p>We provide following facility to patient</p>
            </div>
            <div class="row">
...
?>
  <?php  echo $row['PageDescription'];?> <br>
    ...
    <div class="copy">
            <div class="container">
         Hospital Management System Developed By Janmejay Singh
           </div>
        </div>
    </body>
